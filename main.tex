...
This lack of multi-model studies is in contradiction with the importance that is attributed to such studies in our author survey. This finding is certainly transferable to the larger international modelling community, where many authors

%A contradictory behaviour emerges from the conducted survey, that we think holds also for the international hydrological community: while hydrologists think epistemic uncertainty -- i.e. our lack of knowledge on several components of an hydrological system -- is important to advance our understanding in hydrological modelling, and they 
more or less indirectly advocate the development of methods that facilitate robust model development \citep{Zheng2018}, but most of them do not apply these principles themselves.

%comBS: nice citation but does not fit the objective of the paper, which is to understand diversity
...
%comBS: text below does not seem to belong to our conclusion?
...
% need a note on why we think the results are valid outside switzerland, what is special here, what not?, 
This study focused on a selected, small country and revealed how local specificities contributed to model diversification. XXXXX
