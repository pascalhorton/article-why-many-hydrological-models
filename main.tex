...
WaSiM \citep{Thornton2021}. ALPINE3D, which is built on the
...
model; \citealp{Bergstrom1976a,Bergstrom1992,Bergstrom1995,Lindstr_m_1997}) 
is a rainfall-runoff model that focuses
...
\textbf{RS} (Routing System; \citealp{Dubois2000, GarciaHernandez2020, Foehn2020}) has been developed at the
...
\textbf{WaSiM} (Water Flow and Balance Simulation
Model; \citealp{Schulla2007,Schulla2009}) is a fully distributed hydrological
model originally developed at ETH Zurich under the name WaSiM-ETH. It describes the water fluxes
...
with the kinematic wave approach (from one cell to another). WaSiM
