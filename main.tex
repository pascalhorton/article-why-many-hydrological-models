...
The development of hydrological models 

 Similarly, the ability of WaSiM-ETH to accurately reproduce spatio-temporal soil moisture patterns has been assessed by \citet{Rossler2010}, with moderate accuracy for the absolute soil moisture variability, but higher accuracy for its dynamic.
...
\citet{Ancey2019} reconstructed the 1818 Giétro glacial lake outburst flood with GERM (which was also ready to use for this area). %The 1818 Giétro Glacial Lake Outburst Flood has been modelled by (Ancey et al., 2019) with GERM to assess the lake’s water supply before the event, accounting for snow and glacier processes.

ALPINE3D was also used by \citet{Hindshaw2011} to attribute the origin of systematic seasonal and diurnal variations in glacial stream water chemistry
...
ALPINE3D , and by \citet{Brauchli2017} to assess the influence of small-scale snowmelt variations on the catchment-scale hydrologic response.

ALPINE3D was used by (Bavay et al., 2009) to assess the future snow cover and the related discharge in two alpine catchments with different size. The emphasis of  ALPINE3D on snow processes drove the choice of the model. The authors emphasize its verification for alpine processes and a previous use for a climate change impact study. Later, (Bavay et al., 2013) used ALPINE3D for a climate change impact study on snow cover and runoff on a larger region. Adequacy to the climate change context, and of the snow and glacier processes are supported by references. Similarly, (Marty et al., 2017) used ALPINE3D to assess the impact of climate change on future snow cover in two large alpine regions. 

GERM was applied by (Junghans et al., 2011) along with HBV to assess present and future snow and ice melt impact on streamflow, particularly for low-flow conditions in summer. (Farinotti et al., 2012) used GERM to assess climate change’s impact on the runoff in high-alpine glacierized catchments. Their work focused on assessing the uncertainty and the establishment of water management guidelines, specifically for catchments with a high degree of glacier coverage that are expected to undergo significant changes. (Finger et al., 2013) also used GERM to analyse the impact of climate change in the specific context of a glacierized catchment with a karstic environment (the Glacier de la Plaine Morte in the Crans-Montana region).

(Jenicek et al., 2018) used HBV-light to assess the impact of future changes in the snowpack on the summer low flows. 

Several studies were performed in the catchment of the Rhone. The distributed version of PREVAH was used by (Zappa & Kan, 2007) to quantify the hydrological response to the 2003 heatwave of a glacierized catchment (Rhone at Gletsch), along with non-glacierized catchments. (Finger et al., 2011) applied TOPKAPI-ETH for the same basin and adapted it to better represent the snow and glacier melt. (Uhlmann et al., 2013) assessed a glacier’s behaviour under a stable climate using a stochastic meteorological data generator and GSM-SOCONT in RS, and at the same time (Uhlmann et al., 2012) assessed the effects of a progressively warming climate within the same set up (see also Climate change impact studies).

(Verbunt et al., 2003) used WaSIM-ETH to investigate the contribution of snow and glaciers to the discharge of three alpine catchments in different regions of the Swiss Alps 

The snow module of WaSIM-ETH was also used by (Thornton et al., 2019) in the Vallon de Nant for distributed snow simulations “on account of its strong capabilities following a thorough review”.

ALPINE3D was used by (Comola et al., 2015) and (Brauchli et al., 2017) in the Dischma catchment to assess the effects of solar radiation patterns on the snowmelt dynamic and of snow distribution and water transport within the snowpack on the hydrologic response, respectively.  The use of ALPINE3D was justified by the fact that it has “shown to provide reliable snowmelt predictions in numerous studies related to snow hydrology” (Comola et al., 2015). It was also used in the same catchment by (Wever et al., 2017) to analyze the influence of snow processes on the soil moisture and streamflow, benefitting from an update of the model’ soil module. (Shakoor et al., 2018) compared temperature index and energy balance melt methods for snow and ice using ALPINE3D. This model was selected for its realistic snow cover development and melt in the complex steep terrains.
...
\citet{Stucki2018} reconstructed a large flood of the 19th Century in Ticino with PREVAH coupled with the routing part of RS %For the reconstruction of a large flood of the 19th Century in Ticino, (Stucki et al., 2018) used PREVAH coupled with RS to take into account the effect of regulations and hydropower plants present nowadays. 
...
The configuration of PREVAH for Ticino originates from the work of (Andres et al., 2016), who used PREVAH coupled to RS to take into account the effects of hydropower systems and channel routing. 

Fatichi et al., 2014) to analyse the importance of internal climate variability compared to the climate change signal in the Rhone catchment. Its suitability for the case study is supported by its ability to account for hydraulic infrastructures
(Fatichi et al., 2015) used TOPKAPI-ETH again on the Rhone catchment to study the interaction between climate change effects and hydropower operations. 
”. (Anghileri et al., 2018) also chose TOPKAPI-ETH to study the impact of climate change and energy policies in the Visp valley (Mattmark dam), referring to the studies mentioned above to motivate the adequacy of the model. This application adds the aspects of glaciers dynamics and hydropower operation scenarios depending on water availability and electricity prices.

SWAT: work of (Rahman et al., 2013), who implemented anthropogenic influences in the model configuration to account for the hydropower networks as well as snow and glacier melt processes

(Verbunt et al., 2005) chose WaSiM-ETH to analyse the impact of hydropower activities and land cover changes on the Alpine Rhine basin’s hydrological response. 
...
(Foglia et al., 2009) used TOPKAPI-ETH as a part of an integrated modelling framework to analyse interactions between the river, the aquifer and the ecosystem in the Maggia Valley. The use of TOPKAPI-ETH was justified by the fact that it “was shown to work well for simulating peak flows in the Maggia Valley”, based on previous work
...
(Schattan et al., 2013) used the fully distributed version of PREVAH to assess the impact of forest change (due to climate change) on hydrology in Switzerland. Coupling the hydrological model to a spatio-temporal forest model could quantify the impact of the rising treeline and forest degradation in lower altitude due to future extreme drought events.

The impact of climate change on brown trout due to changes in discharge has been assessed by (Junker et al., 2015). The fully distributed version of PREVAH was used to simulate the future discharge conditions because “this version allows for the assimilation of land-use change scenarios and for improved coupling with further impact models such as the bedload transport model” (Junker et al., 2015). 
...
The most widely used models to study climate change impact on streamflow are to date however the reservoir-based models PREVAH (\citealt{Koplin2012, Speich_2015, Junker_2014, Milano2015a, Brunner2019c} and others;  see Supplementary material) and HBV-light (\citealt{Etter2017, Hakala2020, Brunner_2018, Jenicek2018}  and others). In the western part of Switzerland, RS and GSM-SOCONT were used in the past, especially for high elevation sites \citep{Horton2006, Uhlmann_2012, Uhlmann2013a, Terrier2015}. The justification of these models for climate change impact assessments is well summarized by \citet{Koplin2010} who, for PREVAH, states that the model ``has been developed especially to suit conditions in mountainous environments'' and that it ``has proved to be a reliable and flexible tool for various scopes of application and climate conditions ranging from drought analysis over water balance modelling to flood estimation and forecasting''. 
